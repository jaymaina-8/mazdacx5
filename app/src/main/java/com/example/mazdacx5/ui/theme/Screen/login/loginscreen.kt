package com.example.mazdacx5.ui.theme.Screen.login
...
import com.example.mazdacx5.Navigations.ROUTE_HOME
    ...
    Column(
        ...
        Button(
            onClick = {
                ...
                println("Login button clicked with email: ${email.text} and password: ${password.text}")
